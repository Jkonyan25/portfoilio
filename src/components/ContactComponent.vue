    ...
    <div class="contact">
        <ul class="contact__list">
            <li class="contact__item">
                <a href="https://www.linkedin.com/in/jkonyan/" target="_blank" class="contact__link contact__link--linkedin">
                    <span class="contact__label">Linkedin</span> <font-awesome-icon :icon="['fab', 'linkedin']" />
                </a>
            </li>

            <li class="contact__item">
                <a href="https://github.com/jkonyan25" target="_blank" class="contact__link contact__link--github">
                    <span class="contact__label">Github</span> <font-awesome-icon :icon="['fab', 'github']" />
                </a>
            </li>

            <li class="contact__item">
                <a href="mailto:Jkonyan@gmail.com" target="_blank" class="contact__link contact__link--email">
                    <span class="contact__label">Email</span> <font-awesome-icon :icon="['far', 'envelope']" />
                </a>
            </li>

            <li class="contact__item">
                <a href="https://drive.google.com/file/d/1Wx97hdRWqI9bSb1eP7UzGX6OJJhraW7Y/view?usp=sharing" target="_blank" class="contact__link contact__link--resume">
